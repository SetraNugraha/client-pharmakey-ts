    ...
    <>
      <div className="pt-[30px] px-[16px]">
        <div className="relative w-full">
          <img src="assets/img/bg-doctor.png" alt="bg-doctor" className="w-full" />
          <div className="absolute top-[50px] left-[20px]">
            ...
            <Link
              to="/doctors"
              className="py-2 px-9 bg-white rounded-[50px] font-bold text-primary shadow-xl  hover:text-white hover:bg-primary transition-all duration-300 ease-in-out"
            >
              Explore
            </Link>
          </div>
