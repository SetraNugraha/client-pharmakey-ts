...
export default function AdminCategory() {
        ...
        <tr key={category.id} className="w-full bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
          ...
          <td className="py-3">
            <div className="flex justify-center items-center">
              <img src={category.image_url || "/assets/img/no-image.png"} alt="icon-category" className="size-11 rounded-full" />
            </div>
          </td>
  ...
  return (
    <section className="px-10 py-5">
      {/* Loading while Deleting Category */}
      <LoadingOverlay isLoading={deleteCategory.isPending} />
